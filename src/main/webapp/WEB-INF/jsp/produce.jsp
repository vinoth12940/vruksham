...
<body>
	...
	<br>
	<br>
	<div id="offerings" class="container-fluid text-center bg-grey" style="padding-left: 100px;padding-right: 100px">
		...
		<div class="row text-center slideanim">
			...
			<div class="col-sm-6">
				...
				<br>
				<h4 style="text-align:  justify;">We started our farming journey with rice and pulses and we never looked back since then. The rices and pulses are organically grown with at most care and we provide the nourishment from the age old practices on a periodic basis which gives us more yield per hectare. We cultivate lot of varieties of local rice and all types of pulses. Contact us for more information.</h4>
			</div>
		</div>
		<div class="row text-center slideanim">
			<div class="col-sm-6">
