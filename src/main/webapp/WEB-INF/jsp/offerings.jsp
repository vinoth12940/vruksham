...
<body>
	...
	<div id="offerings" class="container-fluid text-center bg-grey" style="padding-left: 100px;padding-right: 100px">
		<div class="jumbotron text-center" style="background-color: white;">
			...
			<br>
			<h4 style="color: black; text-align:  justify;">Check out what is happening at the farm. We have events happening all year. Our current services include organic farming workshops, Nursery tour and Introductions to Landscaping. Some of our events will include a one day at the farm for school and college students where they can learn the day to day activities in a farm. This will be a field trip organized by the respective schools or colleges. See our services below and sign up to our newsletter to guarantee you do not miss out on any of them!</h4>
		</div>
